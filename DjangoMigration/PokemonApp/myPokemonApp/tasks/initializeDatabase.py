...
def scriptToInitializeDatabase():
    ...
    # Version organisée par type pour référence
    # moves_by_type = {
    #     'normal': [
    #         'Pound', 'Karate Chop', 'Double Slap', 'Comet Punch', 'Mega Punch', 'Pay Day',
    #         'Scratch', 'Vice Grip', 'Guillotine', 'Razor Wind', 'Swords Dance', 'Cut',
    #         'Whirlwind', 'Bind', 'Slam', 'Stomp', 'Mega Kick', 'Sand Attack', 'Headbutt',
    #         'Horn Attack', 'Fury Attack', 'Horn Drill', 'Tackle', 'Body Slam', 'Wrap',
    #         'Take Down', 'Thrash', 'Double-Edge', 'Tail Whip', 'Leer', 'Bite', 'Growl',
    #         'Roar', 'Sing', 'Supersonic', 'Sonic Boom', 'Disable', 'Strength', 'Quick Attack',
    #         'Rage', 'Mimic', 'Screech', 'Double Team', 'Recover', 'Harden', 'Minimize',
    #         'Smokescreen', 'Defense Curl', 'Focus Energy', 'Bide', 'Metronome', 'Self-Destruct',
    #         'Egg Bomb', 'Swift', 'Skull Bash', 'Spike Cannon', 'Constrict', 'Soft-Boiled',
    #         'Glare', 'Barrage', 'Lovely Kiss', 'Transform', 'Dizzy Punch', 'Flash',
    #         'Splash', 'Explosion', 'Fury Swipes', 'Sharpen', 'Conversion', 'Tri Attack',
    ...
    #     ],
    #     'water': [
    #         'Water Gun', 'Hydro Pump', 'Surf', 'Bubble Beam', 'Withdraw', 'Waterfall',
    #         'Clamp', 'Bubble', 'Crabhammer'
    #     ],
    #     'electric': [
    #         'Thunder Punch', 'Thunder Shock', 'Thunderbolt', 'Thunder Wave', 'Thunder'
    #     ],
    #     'grass': [
    #         'Vine Whip', 'Absorb', 'Mega Drain', 'Leech Seed', 'Growth', 'Razor Leaf',
    #         'Solar Beam', 'Poison Powder', 'Stun Spore', 'Sleep Powder', 'Petal Dance', 'Spore'
    #     ],
    #     'ice': [
    #         'Ice Punch', 'Mist', 'Ice Beam', 'Blizzard', 'Aurora Beam', 'Haze'
    #     ],
    #     'fighting': [
    #         'Double Kick', 'Jump Kick', 'Rolling Kick', 'Low Kick', 'Counter',
    #         'Seismic Toss', 'Submission', 'High Jump Kick'
    #     ],
    #     'poison': [
    #         'Poison Sting', 'Acid', 'Poison Gas', 'Smog', 'Sludge', 'Toxic', 'Acid Armor'
    #     ],
    #     'ground': [
    #         'Bone Club', 'Earthquake', 'Fissure', 'Dig', 'Bonemerang'
    #     ],
    #     'flying': [
    #         'Gust', 'Wing Attack', 'Fly', 'Peck', 'Drill Peck', 'Mirror Move', 'Sky Attack'
    #     ],
    #     'psychic': [
    #         'Psybeam', 'Hypnosis', 'Meditate', 'Agility', 'Confusion', 'Psychic',
    #         'Teleport', 'Barrier', 'Light Screen', 'Reflect', 'Amnesia', 'Kinesis',
    #         'Dream Eater', 'Psywave', 'Rest', 'Psycho Cut', 'Psystrike'
    #     ],
    #     'bug': [
    #         'Twineedle', 'Pin Missile', 'String Shot', 'Leech Life'
    #     ],
    #     'rock': [
    #         'Rock Throw', 'Rock Slide'
    #     ],
    #     'ghost': [
    #         'Night Shade', 'Confuse Ray', 'Lick'
    #     ],
    #     'dragon': [
    #         'Dragon Rage'
    #     ]
