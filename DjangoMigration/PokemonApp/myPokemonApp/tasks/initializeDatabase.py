...
def scriptToInitializeDatabase():
    ...
    abilities_data = [
        ...
        ("Poison Heal",   "Régénère 1/8 des HP au lieu de prendre des dégâts de poison.", "poison_heal", "end_of_turn"),
        # --- Attaque ---
        ...
        # --- Passifs Gen 1 (effets non encore codés) ---
        ("Compound Eyes", "Augmente la précision des attaques.",                     None,            "passive"),
        ("Tinted Lens",   "Les attaques peu efficaces font x2 dégâts.",              None,            "passive"),
        ...
        ("Immunity",      "Immunité au poison.",                                     None,            "on_status"),
        ("Insomnia",      "Immunité au sommeil.",                                    None,            "on_status"),
        ("Limber",        "Immunité à la paralysie.",                                None,            "on_status"),
        ("Oblivious",     "Immunité à la fascination.",                              None,            "on_status"),
        ("Own Tempo",     "Immunité à la confusion.",                                None,            "on_status"),
        ("Synchronize",   "Transmet le statut infligé à l'adversaire.",              None,            "on_status"),
        ("Natural Cure",  "Guérit le statut au retrait du combat.",                  None,            "on_switch_out"),
        ("Static",        "20 % de chance de paralyser au contact.",                 None,            "on_damage_taken"),
        ("Flame Body",    "30 % de chance de brûler au contact.",                    None,            "on_damage_taken"),
        ("Poison Point",  "30 % de chance d'empoisonner au contact.",                None,            "on_damage_taken"),
        ("Effect Spore",  "30 % de chance de statut au contact.",                    None,            "on_damage_taken"),
        ("Serene Grace",  "Double la chance des effets secondaires.",                None,            "on_attack"),
        ("Cute Charm",    "30 % de chance de fasciner au contact.",                  None,            "on_damage_taken"),
        ("Thick Fat",     "Réduit les dégâts Feu et Glace de 50 %.",                 None,            "on_damage_taken"),
        ("Rock Head",     "Supprime les dégâts de recul.",                           None,            "on_attack"),
        ("Sand Veil",     "Augmente l'Esquive sous la tempête de sable.",            None,            "modify_stat"),
        ("Shed Skin",     "30 % de chance de guérir le statut à la fin du tour.",    None,            "end_of_turn"),
        ("Inner Focus",   "Immunité au recul.",                                      None,            "passive"),
        ("Hyper Cutter",  "L'Attaque ne peut pas être baissée.",                     None,            "passive"),
        ("Keen Eye",      "La précision ne peut pas être baissée.",                  None,            "passive"),
        ("Shell Armor",   "Immunité aux coups critiques.",                           None,            "on_damage_taken"),
        ("Clear Body",    "Les stats ne peuvent pas être baissées.",                 None,            "passive"),
        ("White Smoke",   "Les stats ne peuvent pas être baissées.",                 None,            "passive"),
        ("Pressure",      "L'adversaire perd 2 PP supplémentaires à chaque attaque.", None,           "passive"),
        ("Trace",         "Copie le talent de l'adversaire à l'entrée.",             None,            "on_switch_in"),
        ("Illuminate",    "Augmente le taux de rencontres sauvages.",                None,            "on_capture"),
        ...
        ("Stench",        "10 % de chance de faire reculer l'adversaire.",           None,            "on_attack"),
    ]
