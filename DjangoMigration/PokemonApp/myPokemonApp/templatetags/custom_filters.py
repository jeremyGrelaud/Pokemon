...
_ITEM_SPRITE_MAP = {
    ...
    'baie sitrus':              ('hold-item', 'sitrus-berry.png'),
    'baie oran':                ('hold-item', 'oran-berry.png'),
    'baie lum':                 ('hold-item', 'lum-berry.png'),
    'baie yache':               ('hold-item', 'yache-berry.png'),
    'baie chople':              ('hold-item', 'chople-berry.png'),
    'baie pêche':               ('hold-item', 'pecha-berry.png'),
    'baie peche':               ('hold-item', 'pecha-berry.png'),
    'baie mepo':                ('hold-item', 'chesto-berry.png'),
    'baie gribi':               ('hold-item', 'pecha-berry.png'),    # alias antidote
    'baie rago':                ('hold-item', 'rawst-berry.png'),
    'baie glace':               ('hold-item', 'aspear-berry.png'),
    'bandeau choix':            ('hold-item', 'choice-band.png'),
    'foulard choix':            ('hold-item', 'choice-scarf.png'),
    'orbe vie':                 ('hold-item', 'life-orb.png'),
    'veste assaut':             ('hold-item', 'assault-vest.png'),
    ...
    'charbon':                  ('hold-item', 'charcoal.png'),
    'eau mystique':             ('hold-item', 'mystic-water.png'),
    'filtre miroir':            ('hold-item', 'twisted-spoon.png'),
    'herbe miracle':            ('hold-item', 'miracle-seed.png'),
    'écharpe soie':             ('hold-item', 'silk-scarf.png'),
    'echarpe soie':             ('hold-item', 'silk-scarf.png'),
    # ── Objets clefs ─────────────────────────────────────────────────────
