...
_ITEM_SPRITE_MAP = {
    ...
    'baie sitrus':              ('berry', 'sitrus.png'),
    'baie oran':                ('berry', 'oran.png'),
    'baie lum':                 ('berry', 'lum.png'),
    'baie yache':               ('berry', 'yache.png'),
    'baie chople':              ('berry', 'chople.png'),
    'baie pêche':               ('berry', 'pecha.png'),
    'baie peche':               ('berry', 'pecha.png'),
    'baie mepo':                ('berry', 'chesto.png'),
    'baie gribi':               ('berry', 'pecha.png'),       # alias antidote
    'baie rago':                ('berry', 'rawst.png'),
    'baie glace':               ('berry', 'aspear.png'),
    'bandeau choix':            ('hold-item', 'choice-band.png'),
    'foulard choix':            ('hold-item', 'choice-scarf.png'),
    'orbe vie':                 ('hold-item', 'life-orb.png'),
    'veste assaut':             ('hold-item', 'assault-vest.png'),
